const cursor_circle = document.querySelector(".cursor-circle"),
    ...
    image_wrap = document.querySelector(".img-wrap");
...
image_wrap.addEventListener("mousemove", (e) => {
    ...
    image_wrap.style.backgroundPosition = `calc(20% + ${xMoving*xSpeed}px) calc(25% + ${yMoving * ySpeed}px)`;
});
...
image_wrap.addEventListener("mouseout", () => {
    ...
    image_wrap.style.backgroundPosition = "20% 25%"
});
